...
* Итоговый [проект](https://github.com/anondigriz/flask-ai-demo-2022-03)

### Занятие 28 мар 2022 (ПН)

| Тема | Тип |
| --- | --- |
| Создание чат-бота с применением нейронных сетей | Практикум |
...
| Тема | Тип |
| --- | --- |
| Создание чат-бота с применением нейронных сетей | Самостоятельная работа |

План:

* Самостоятельное создание чат-бота с применением нейронных сетей

Материал:

* Задание [занятия](src/28-03-2022/README.md)
