...
* Самостоятельная работа с датасетами на выбор
...
| Тема | Тип |  Преподаватель |
| --- | ---| --- |
| Обработка пропусков в данных, кодирование категориальных признаков, масштабирование данных | Практикум | Аладин Дмитрий Владимирович |
